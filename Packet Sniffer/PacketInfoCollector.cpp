...
//	cout << setw(WIDTH_SPECIFIER) <<"\tNumber of TCP Packets: " << num_tcp_packets << endl;
	...
	cout << setw(WIDTH_SPECIFIER) << "ICMP" << setw(WIDTH_SPECIFIER) << num_icmp_packets << 
			setw(WIDTH_SPECIFIER) << ((double)num_icmp_packets/(double)(num_icmp_packets + num_tcp_packets + num_udp_packets))*100<<"%" << endl;
	cout << setw(WIDTH_SPECIFIER) << "TCP" << setw(WIDTH_SPECIFIER) << num_tcp_packets << 
			setw(WIDTH_SPECIFIER) << ((double)num_tcp_packets/(double)(num_icmp_packets + num_tcp_packets + num_udp_packets))*100<<"%" << endl;
	cout << setw(WIDTH_SPECIFIER) << "UDP" << setw(WIDTH_SPECIFIER) << num_udp_packets << 
			setw(WIDTH_SPECIFIER) << ((double)num_udp_packets/(double)(num_icmp_packets + num_tcp_packets + num_udp_packets))*100<<"%" << endl;
